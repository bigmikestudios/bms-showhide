...
wp_register_script('bms_showhide', plugins_url() .'/bms_showhide/bms_showhide.js', array('jquery'));
wp_enqueue_script('bms_showhide');

wp_register_style('bms_showhide', plugins_url() .'/bms_showhide/bms_showhide.css');
...
function bms_showhide ($atts, $content=null)
{
	...
	if (isset($atts['readless'])) {
		$return .= "<span class='bms-sh-more'>".$label."</span><span class='bms-sh-less'>".$atts['readless']."</span>".$cr;
	} else {
		$return .= $atts['label'];
	}
